...
- Hay que diferenciar entre **Docker Compose** y **Docker Swarm**.
	...
	- Docker Compose no proporciona escalado automático ni se puede definir el escalado en el fichero `docker-compose.yml`
	- Docker Swarm permite escalado automático o definir las instancias necesarias dentro del fichero `docker-compose.yml` 
